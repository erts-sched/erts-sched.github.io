...
- **2026-09** — [ElixirLS: binding the MCP server to loopback](security/elixir-ls-mcp-loopback/) — the same class in a second BEAM tool, at a lower severity, as a hardening PR with a red/green test: [elixir-lsp/elixir-ls#1275](https://github.com/elixir-lsp/elixir-ls/pull/1275), [measurements](https://github.com/erts-sched/elixir-ls-mcp-bind-measurements).
